...
As we approach the summer break, there's still one final stop to make. To close out the first half of the year, we're bringing back two familiar faces from the community to share hard-earned lessons, stories that have been years in the making, and the kind of technical tips and tricks that are always worth taking notes on.

To kick things off, José Coixão (@José Coixão) returns to our stage with what promises to be the final chapter in a long-running journey through the PlayStation scene. From the most notable PS5 exploits publicly known today to the twists and turns that shaped the ecosystem, he will connect the dots and share the story behind the breakthroughs. And, as if that wasn't enough, expect a spicy surprise waiting at the end.

But wait, there's more. César Silva (@apl3b) will take us on a different kind of journey, from using Mona to pop shells to actively contributing to one of the most well-known exploitation tools in the field. Through code rewrites, the Python 3 migration, and the release of Mona v3, he will show that open-source contributions come in many forms. Whether you're a developer, researcher, or just looking for a way to give back, this talk will be a good reminder about what it means to contribute.

Just a friendly reminder, this is an in-person event. Before RSVPing, please double-check that you can attend and be there in person. Good logistics rely on it! And a quick note regarding venue rules, please be mindful when taking photos and avoid capturing the company space, screens, and staff.
...
- "A Brief History of the Playstation Scenes - Finale" (PT/EN) by José Coixão (@José Coixão)
- "From POP to PUSH" (PT/EN) by César Silva (@apl3b)

**\[Challenge\]**

Spring cleaning is due! Don't forget to tidy up your house, clean your systems, and make your own backups for a Secure Summer.

Speaking of backups… we found one. The machine is fully locked down, so nobody should be able to access it. Not even the administrator remembers the password. Sounds safe, right?
 
Think you can hack your way in? Find the flag and ping @darkcookie.
